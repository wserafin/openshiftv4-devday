...
```
$ oc delete deployment/crashing-app
```
...
```
$ oc set probe deployment/nodejs-ex --liveness --readiness --initial-delay-seconds=30 --failure-threshold=3 --get-url=http://:8080/healthz
```
